import { useGetPlotNFTsQuery, usePwSelfPoolMutation, usePwJoinPoolMutation } from '@serwisgalena/api-react';
import { Flex, State, Loading, StateTypography } from '@serwisgalena/core';
