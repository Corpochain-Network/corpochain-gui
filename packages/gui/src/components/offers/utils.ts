...
import type { OfferSummaryAssetInfo, OfferSummaryRecord } from '@serwisgalena/api';
import { mojoToCAT, mojoToChia, mojoToCATLocaleString, mojoToChiaLocaleString } from '@serwisgalena/core';
...
export function summaryStringsForNFTOffer(
  ...
  // TODO: Remove 1:1 NFT <--> CCH assumption
