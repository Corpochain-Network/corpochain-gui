import { OfferTradeRecord } from '@serwisgalena/api';
import {
  ButtonLoading,
  CopyToClipboard,
  DialogActions,
...
const log = debug('corpochain-gui:offers');
...
const testnetDummyHost = 'offers-api-sim.corpochain.pl';
...
enum HashgreenErrorCodes {
  ...
  MARKET_NOT_FOUND = 50_029, // Pairing doesn't exist e.g. CCH/RandoCoin
