...
type CreateDefaultValuesParams = {
  walletType?: WalletType; // CAT or STANDARD_WALLET (CCH), indicates whether a token or CAT has a default entry
 ...
 * for creating an CCH offer, a CAT offer, or an NFT offer. CCH and CAT offers will have a default entry in
