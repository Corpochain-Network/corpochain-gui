import { defaultPlotter, toBech32m, fromBech32m, WalletCreatePool } from '@serwisgalena/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@serwisgalena/api-react';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@serwisgalena/core';
