...
import { useGetDIDQuery, useGetDIDNameQuery, useSetDIDNameMutation } from '@serwisgalena/api-react';
import { Color, CopyToClipboard, Flex, Suspender, Tooltip, truncateValue } from '@serwisgalena/core';
