...
export class LoginPage {
  ...
  async changePassphrase() {
    ...
    await this.page
      .locator('text=Current PassphraseCurrent Passphrase >> input[type="password"]')
      .fill('Wafisimah2022!@');
    ...
    await this.page
      .locator('text=Confirm New PassphraseConfirm New Passphrase >> input[type="password"]')
      .fill('Wafisimah2022!#');
  ...
  await page.waitForURL('file:///Users/jahifaw/Documents/Code/chia-tn-pw-latest/corpochain/corpochain-gui/packages/gui/build/renderer/index.html#/dashboard/settings/general');
