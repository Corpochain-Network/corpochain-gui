...
//   // await page.getByRole('option', { name: 'Corpochain Holiday 2021 Token (CH21)' }).click();
...
//   await page.locator('text=Amount *TCCH >> input[type="text"]').fill('0.05');
...
//   await page
//     .locator('text=Create an NFT OfferBuy an NFTSell an NFTYou will offerAmount *TCCH50,000,000,000 >> button')
//     .first()
//     .click();
...
//   await page.locator('text=You will offerAsset Type *​Amount *TCCH >> input[type="text"]').fill('0.00000000005');

//   // And I complete Amount under heading In exchange for
//   await page.locator('text=In exchange forAsset Type *​Amount *TCCH >> input[type="text"]').fill('0.00000000005');
