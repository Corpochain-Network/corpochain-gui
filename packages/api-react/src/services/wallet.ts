...
import { CAT, DID, Farmer, NFT, Pool, WalletService, WalletType, toBech32m, VC } from '@serwisgalena/api';
import type { NFTInfo, Transaction, Wallet, WalletBalance } from '@serwisgalena/api';
