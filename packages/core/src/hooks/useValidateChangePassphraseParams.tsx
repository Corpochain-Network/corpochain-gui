import { useGetKeyringStatusQuery } from '@serwisgalena/api-react';
    ...
    try {
      ...
      if (newPassphrase !== confirmationPassphrase) {
        ...
        if (currentPassphrase === null) {
          ...
          message = (
            <Trans>
              Setting a passphrase is strongly recommended to protect your keys. Are you sure you want to skip setting a
              passphrase?
            </Trans>
          );
        } else {
          ...
          message = (
            <Trans>
              Using a passphrase is strongly recommended to protect your keys. Are you sure you want to disable
