import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@serwisgalena/api-react';
import { CardSimple, Flex, TooltipIcon } from '@serwisgalena/core';
            ...
            <Flex alignItems="center" gap={1}>
              ...
              <TooltipIcon>
                <Trans>
                  ...
                  number is generally higher if you have a lot of transactions or canceled offers for CCH, CATs, or
